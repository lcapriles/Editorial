...
module WillPaginate
  ...
  module ViewHelpers
    ...
    # ==== Options
    # Display options:
    # * <tt>:previous_label</tt> -- default: "« Anterior" (this parameter is called <tt>:prev_label</tt> in versions <b>2.3.2</b> and older!)
    # * <tt>:next_label</tt> -- default: "Proximo »"
